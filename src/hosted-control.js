...
export function createHostedControlServer({ controlPlane, sessionSecret, sessionKeys, activeSessionKeyId, sessionRevocationFile, billingWebhookSecret, rateLimit={capacity:120,refillPerSecond:2,maxKeys:10_000}, observe=()=>undefined }={}) {
